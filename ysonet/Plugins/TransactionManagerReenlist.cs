        ...
        static OptionSet options = new OptionSet()
            {
                ...
                {"legacyfx", "Target the .NET Framework 2.0/3.0/3.5 (CLR v2) generation. This reaches the GADGET only; this plugin's own 5-byte frame names no framework assembly, so it needs no rewriting. Default: false", v => legacyFx = v != null },
