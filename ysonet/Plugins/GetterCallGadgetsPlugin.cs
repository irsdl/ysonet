...
Several chain of gadgets are already implemented in the ysonet.net, see following gadgets:
...
Exemplary usage: 
    ...
    ysonet.exe -p GetterCallGadgets -l
    ...
    ysonet.exe -p GetterCallGadgets -g ListBox -m Method -i .\innergadget.json
