        ...
        internal static OptionSet options = new OptionSet()
            {
                ...
                {"minify", "Minify payloads where applicable. A gadget may refuse --minify when it would rewrite operator data whose characters or bytes must survive exactly. Default: false", v => minify =  v != null },
