...
{
    /// <summary>
    /// Shrinks .NET type and assembly-qualified name strings by dropping the
    /// Version/Culture/PublicKeyToken parts and redundant spaces when the shorter
    /// form still resolves. Used by the BinaryFormatter minifier and by the
    /// vendored ModifiedVulnerableBinaryFormatters writer to keep payloads small.
    /// </summary>
    public class TypeNameMinifier
    {
