    ...
    public sealed class ObjectReader
    {
        ...
        internal Object TopObject
        {
            ...
            set
            {
                ...
                if (m_objectManager != null)
                {
                    var m_objectManagerRef = m_objectManager.GetType();
                    PropertyInfo topObject = m_objectManagerRef.GetProperty("TopObject", BindingFlags.Instance | BindingFlags.NonPublic);
                    topObject.SetValue(m_objectManager, value, null);
        ...
        internal ObjectReader(Stream stream, ISurrogateSelector selector, StreamingContext context, InternalFE formatterEnums, SerializationBinder binder)
        {
            ...
            if (m_binder != null)
            {
                ...
                Type TypeLimitingDeserializationBinderRef = mscorlibAsm.GetType("System.Resources.ResourceReader+TypeLimitingDeserializationBinder");
                var tldBinder = m_binder;
                //ResourceReader.TypeLimitingDeserializationBinder tldBinder = m_binder as ResourceReader.TypeLimitingDeserializationBinder;
                if (tldBinder != null)
                {
                    var objectReader = TypeLimitingDeserializationBinderRef.GetProperty("ObjectReader", BindingFlags.NonPublic | BindingFlags.Instance);
                    objectReader.SetValue(tldBinder, this);
                }
...
#else
                Assembly mscorlibAsm = Assembly.Load("mscorlib, Version=4.0.0.0, Culture=neutral, PublicKeyToken=b77a5c561934e089");
                var ObjectManagerRef = mscorlibAsm.GetType("System.Runtime.Serialization.ObjectManager");

                Type[] types = new Type[] { typeof(ISurrogateSelector), typeof(StreamingContext), typeof(bool), typeof(bool) };

                var ObjectManagerRefConstructor = ObjectManagerRef.GetConstructor(BindingFlags.Instance | BindingFlags.NonPublic, null, types, null);

                m_objectManager = (ObjectManager)ObjectManagerRefConstructor.Invoke(new object[] { m_surrogates, m_context, false, false });
        ...
        {
            //Contract.Assert((index < crossAppDomainArray.Length), "[ysonet.Helpers.ModifiedVulnerableBinaryFormattersObjectReader index out of range for CrossAppDomainArray]");
        ...
        private void ParseArray(ParseRecord pr)
        {
            ...
            else if ((pr.PRarrayTypeEnum == InternalArrayTypeE.Jagged) || (pr.PRarrayTypeEnum == InternalArrayTypeE.Single))
            {
                ...
                if ((pr.PRlowerBoundA == null) || (pr.PRlowerBoundA[0] == 0))
                {
                    ...
                    {
                        Assembly mscorlibAsm = Assembly.Load("mscorlib, Version=4.0.0.0, Culture=neutral, PublicKeyToken=b77a5c561934e089");
                        var ArrayRef = mscorlibAsm.GetType("System.Array");
                        Type[] types = new Type[] { Type.GetType("System.Type"), typeof(int) };
                        var unsafeCreateInstance = ArrayRef.GetMethod("UnsafeCreateInstance", BindingFlags.Static | BindingFlags.NonPublic, null, types, null);
                        pr.PRnewObj = (object)unsafeCreateInstance.Invoke(null, new object[] { pr.PRarrayElementType, pr.PRlengthA[0] });
                ...
                else
                {
                    if ((object)pr.PRarrayElementType != null)
                    {
                        ...
                        Type[] types = new Type[] { Type.GetType("System.Type"), typeof(int) };
                        var unsafeCreateInstance = ArrayRef.GetMethod("UnsafeCreateInstance", BindingFlags.Static | BindingFlags.NonPublic, null, types, null);
                        pr.PRnewObj = (object)unsafeCreateInstance.Invoke(null, new object[] { pr.PRarrayElementType, pr.PRlengthA, pr.PRlowerBoundA });
            ...
            else if (pr.PRarrayTypeEnum == InternalArrayTypeE.Rectangular)
            {
                ...
                if ((object)pr.PRarrayElementType != null)
                {
                    ...
                    if (!pr.PRisLowerBound)
                        pr.PRnewObj = (object)unsafeCreateInstance.Invoke(null, new object[] { pr.PRarrayElementType, pr.PRlengthA });
        ...
        private void RegisterObject(Object obj, ParseRecord pr, ParseRecord objectPr, bool bIsString)
        {
            if (!pr.PRisRegistered)
            {
                ...
                {
                    var m_objectManagerRef = m_objectManager.GetType();
                    var registerString = m_objectManagerRef.GetMethod("RegisterString", BindingFlags.Instance | BindingFlags.NonPublic);
                    registerString.Invoke(m_objectManager, new object[] { (String)obj, pr.PRobjectId, si, parentId, memberInfo });
        ...
        private static Assembly ResolveSimpleAssemblyName(AssemblyName assemblyName)
        {
            ...
            Assembly mscorlibAsm = Assembly.Load("mscorlib, Version=4.0.0.0, Culture=neutral, PublicKeyToken=b77a5c561934e089");
            var RuntimeAssemblyRef = mscorlibAsm.GetType("System.Reflection.RuntimeAssembly");
            Type[] types = new Type[] { typeof(AssemblyName), typeof(Evidence), mscorlibAsm.GetType("System.Threading.StackCrawlMark").MakeByRefType() };
            var loadWithPartialNameInternal = RuntimeAssemblyRef.GetMethod("LoadWithPartialNameInternal", BindingFlags.Static | BindingFlags.NonPublic, null, types, null);
            //Assembly assm = RuntimeAssembly.LoadWithPartialNameInternal(assemblyName, null, ref stackMark);

            object[] arguments = new object[] { assemblyName, null, null };

            Assembly assm = (Assembly)loadWithPartialNameInternal.Invoke(null, arguments);
            stackMark = (StackCrawlMark)arguments[2];

            if (assm == null && assemblyName != null)
            {
                arguments = new object[] { assemblyName.Name, null, null };

                types = new Type[] { typeof(String), typeof(Evidence), mscorlibAsm.GetType("System.Threading.StackCrawlMark").MakeByRefType() };
                loadWithPartialNameInternal = RuntimeAssemblyRef.GetMethod("LoadWithPartialNameInternal", BindingFlags.Static | BindingFlags.NonPublic, null, types, null);

                assm = (Assembly)loadWithPartialNameInternal.Invoke(null, arguments);
                stackMark = (StackCrawlMark)arguments[2];
            }
