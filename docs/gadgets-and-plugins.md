...
```text
ActivitySurrogateDisableTypeCheck (BinaryFormatter (2), LosFormatter (2), NetDataContractSerializer (2), SoapFormatter (2))
ActivitySurrogateSelector (BinaryFormatter (3), LosFormatter (3), SoapFormatter (3))
ActivitySurrogateSelectorFromFile (BinaryFormatter (3), LosFormatter (3), SoapFormatter (3))
AssemblyCatalogLoad (Xaml)
...
BootstrapperBuilder (DataContractJsonSerializer, DataContractSerializer, FastJson, JavaScriptSerializer, Json.NET, MessagePackTypeless, MessagePackTypelessLz4, NetDataContractSerializer, SharpSerializerBinary, SharpSerializerXml, Xaml, YamlDotNet < 5.0.0)
...
ColorConvertedBitmapExtension (Xaml)
...
DataTable (BinaryFormatter (2), LosFormatter (2), SoapFormatter (2))
DataTableTypeSpoof (BinaryFormatter (2), LosFormatter (2), SoapFormatter (2))
...
FileSystemInfoTimeSetter (Xaml (2))
FileSystemProxyCurrentDirectory (DataContractJsonSerializer, DataContractSerializer, Json.NET, MessagePackTypeless, MessagePackTypelessLz4, NetDataContractSerializer)
...
GetterSettingsPropertyValue (Json.NET (4), MessagePackTypeless, MessagePackTypelessLz4, Xaml (5))
HashPEFileHandle (BinaryFormatter, LosFormatter)
...
TypeConfuseDelegate (BinaryFormatter (3), LosFormatter (3), NetDataContractSerializer (3), SoapFormatter (2))
TypeConfuseDelegateFileOperations (BinaryFormatter (5), LosFormatter (5), NetDataContractSerializer (5), SoapFormatter (5))
TypeConfuseDelegateMono (BinaryFormatter, LosFormatter, NetDataContractSerializer)
TypeConfuseDelegateNetFx35 (BinaryFormatter, LosFormatter, SoapFormatter)
TypeConfuseDelegateNetFx40 (BinaryFormatter, LosFormatter, SoapFormatter)
TypeConfuseDelegatePowerShell (BinaryFormatter, LosFormatter)
