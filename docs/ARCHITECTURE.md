...
- Build: `nuget restore ysonet.sln` then `msbuild ysonet.sln -p:Configuration=Release`.
  ...
  `ysonet.Clr2TestHost` executables, `ysonet.Clr4TestHost.exe`, and all host configs.
...
fastJSON 2.1.27, FSharp.Core 3.1.2.5 + FsPickler 4.6 (+ .CSharp/.Json), MessagePack 2.5.301
