---
type: Advisory
title: Untrusted data can lead to DoS attack due to hash collisions and stack overflow in MessagePack
resource: "https://github.com/advisories/GHSA-7q36-4xx7-xcxf"
tags: [advisory, ysonet-reference, en, github-advisory-database]
generated:
  by: ysonet-refs/1
  at: "2026-08-04T17:38:01+00:00"
status: stable
...
canonical_url: ""
cited_by:
  - "docs/dotnet-deserialization-research.md:468"
commit: ""
content_sha256: 4d3057797ed3916e3f00a54a0356df23dfeee8dd9142a125ddbd1bf63321e365
depth: full
depth_reason: default
kind: advisory
language: en
licence: unknown
original_url: "https://github.com/advisories/GHSA-7q36-4xx7-xcxf"
published: 2020-01-31
publisher: GitHub Advisory Database
publisher_english: ""
raw_sha256: aa08e886fbbe50dacb7057d59169daa1006426f9ea31d10150c3e39b0041a73b
retrieved_from: "https://github.com/advisories/GHSA-7q36-4xx7-xcxf"
retrieved_kind: preserved-copy
retrieved_utc: "2026-08-04T17:38:01+00:00"
slug: 2020-github-advisory-database-untrusted-data-can-lead-dos-attack-messagepack
snapshot: ""
title_english: ""
---
...
**Untrusted data can lead to DoS attack due to hash collisions and stack overflow in MessagePack** - Author not stated, GitHub Advisory Database.

- Published: 2020-01-31
- Original: <https://github.com/advisories/GHSA-7q36-4xx7-xcxf>
- Preserved from: https://github.com/advisories/GHSA-7q36-4xx7-xcxf (preserved-copy) on 2026-08-04
- Licence: unknown
...
- `MessagePack` (nuget): < 1.9.11, fixed in 1.9.11
- `MessagePack` (nuget): >= 2.0.0, < 2.1.90, fixed in 2.1.90
- `MessagePack.ImmutableCollection` (nuget): < 1.9.11, fixed in 1.9.11
- `MessagePack.ImmutableCollection` (nuget): >= 2.0.0, < 2.1.90, fixed in 2.1.90
- `MessagePack.ReactiveProperty` (nuget): < 1.9.11, fixed in 1.9.11
- `MessagePack.ReactiveProperty` (nuget): >= 2.0.0, < 2.1.90, fixed in 2.1.90
- `MessagePack.UnityShims` (nuget): < 1.9.11, fixed in 1.9.11
- `MessagePack.UnityShims` (nuget): >= 2.0.0, < 2.1.90, fixed in 2.1.90
- `MessagePack.Unity` (nuget): < 1.9.11, fixed in 1.9.11
- `MessagePack.Unity` (nuget): >= 2.0.0, < 2.1.90, fixed in 2.1.90
