...
resource: "https://docs.metasploit.com/docs/development/developing-modules/libraries/deserialization/dot-net-deserialization.html"
tags: [article, ysonet-reference, en, metasploit-documentation-penetration-tes]
generated:
  by: ysonet-refs/1
...
commit: ""
content_sha256: 4317872cd8a58a912cd634d5bb054b56ba30cbfdf8dc9863f16621518f33ec07
depth: full
depth_reason: default
kind: article
language: en
licence: unknown
original_url: "https://docs.metasploit.com/docs/development/developing-modules/libraries/deserialization/dot-net-deserialization.html"
published: ""
publisher: Metasploit Documentation Penetration Testing Software, Pen Testing Security
publisher_english: ""
raw_sha256: 87363690d049a1bad03d6150275b94de05646977db716d681aa62a22d229b7ce
retrieved_from: "https://docs.metasploit.com/docs/development/developing-modules/libraries/deserialization/dot-net-deserialization.html"
retrieved_kind: preserved-copy
retrieved_utc: "2026-08-04T17:37:53+00:00"
slug: metasploit-documentation-penetration-testing-software-pen-testing-security-dot-n
snapshot: ""
title_english: ""
---
...
**Dot Net Deserialization** - Author not stated, Metasploit Documentation Penetration Testing Software, Pen Testing Security.

- Published: date not stated
- Original: <https://docs.metasploit.com/docs/development/developing-modules/libraries/deserialization/dot-net-deserialization.html>
- Preserved from: https://docs.metasploit.com/docs/development/developing-modules/libraries/deserialization/dot-net-deserialization.html (preserved-copy) on 2026-08-04
- Licence: unknown
...
Adding new gadget chains and formatters involves creating a new file in the respective library directory: [`lib/msf/util/dot_net_deserialization`](https://github.com/rapid7/metasploit-framework/tree/master/lib/msf/util/dot_net_deserialization). The “native” gadget chain type is implemented following the [MS-NRBF](https://docs.microsoft.com/en-us/openspecs/windows_protocols/ms-nrbf/75b9fe09-be15-475f-85b8-ae7b7558cfe5) format and the [Bindata](https://github.com/dmendel/bindata) records as defined in [`types/`](https://github.com/rapid7/metasploit-framework/tree/master/lib/msf/util/dot_net_deserialization/types) subdirectory. Once the new gadget chain or formatter is implemented, it needs to be added to the main library file ([`dot_net_deserialization.rb`](https://github.com/rapid7/metasploit-framework/blob/master/lib/msf/util/dot_net_deserialization.rb)).

Since serialization chain generate is deterministic, a [unit test](https://github.com/rapid7/metasploit-framework/blob/master/spec/lib/msf/util/dot_net_deserialization_spec.rb) should be added for any new gadget chain to ensure that the checksum of the BinaryFormatter representation is consistent.
...
- [How to use command stagers](https://docs.metasploit.com/docs/development/developing-modules/guides/how-to-use-command-stagers.html)
- [How to use Powershell in an exploit](https://docs.metasploit.com/docs/development/developing-modules/libraries/how-to-use-powershell-in-an-exploit.html)
