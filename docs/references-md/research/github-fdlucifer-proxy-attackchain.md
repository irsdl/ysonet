...
- Preserved from: https://github.com/FDlucifer/Proxy-Attackchain (git) on 2026-08-04
...
The bypass payloads below can be dropped straight into the [cve-2020-16875](./CVE-2020-16875/cve-2020-16875.py) poc script in place of the original poc code. The principle of the patch bypass and the analysis of the technique are written out very clearly in the article links above
...
The modified [TypeConfuseDelegateGenerator](./exch_CVE-2021-42321/TypeConfuseDelegateGenerator.cs)

- ![](./pics/TypeConfuseDelegateGenerator.png)

Compared with the original [TypeConfuseDelegateGenerator-origin](./exch_CVE-2021-42321/TypeConfuseDelegateGenerator-origin.cs)
...
Add this ClaimsPrincipal+ActivitySurrogateDisableTypeCheck deserialization chain to the [CVE-2021-42321_shell_write_exp.py](./CVE-2021-42321_shell_write_exp.py) exp script
...
The flow that loads e.dll in the [ActivitySurrogateSelectorGenerator.cs](./ysoserial.net-modified/ysoserial/Generators/ActivitySurrogateSelectorGenerator.cs) file
...
Add this ClaimsPrincipal+ActivitySurrogateSelector deserialization chain to the [CVE-2021-42321_shell_write_exp.py](./exch_CVE-2021-42321/CVE-2021-42321_shell_write_exp.py) exp script
...
Then put the encoded data into [DataSetTypeSpoofGenerator.cs](./CVE-2022-23277-main/ObjectDataProviderGenerator.cs)
...
3. Using metasploit's [Microsoft Exchange Server ChainedSerializationBinder RCE module](./CVE-2022-23277-main/exchange_chainedserializationbinder_rce.rb)
...
- [self-written script getsid.py](./proxymaybeshell/ProxyMaybeShell-main/getsid.py)
...
The X-Rps-CAT can be obtained with the [proxyshellwithsid.py](./proxymaybeshell/ProxyMaybeShell-main/proxyshellwithsid.py) script
...
After modifying the poc, the write is accessed with [proxynotshellfileWrite.py](./proxymaybeshell/ProxyMaybeShell-main/proxynotshellfileWrite.py). Writing the earlier plain aspx one-line shell from proxyshell succeeds but reports a compilation error
...
Then put the encoded data into the [proxynotshellfileWrite.py](./proxymaybeshell/ProxyMaybeShell-main/proxynotshellfileWrite.py) script as follows:
