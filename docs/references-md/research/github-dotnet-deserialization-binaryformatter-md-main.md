...
commit: ""
content_sha256: 5aa549d182573abcf454164a7aa8c271777eecc74029c812f6747a17111c185f
depth: full
...
- Preserved from: https://github.com/Y4er/dotnet-deserialization/blob/main/BinaryFormatter.md (github-api) on 2026-08-04
- Licence: unknown
...
Delegate da = new Comparison<string>(String.Compare);
// merge two string comparers into one multicast delegate
Comparison<string> d = (Comparison<string>)MulticastDelegate.Combine(da, da);
// the Create() function returns new ComparisonComparer<T>(d)
IComparer<string> comp = Comparer<string>.Create(d);
// assign the ComparisonComparer to the SortedSet's comparer
SortedSet<string> set = new SortedSet<string>(comp);
// set.Add("cmd.exe")
